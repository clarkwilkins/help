...
function PickerConstructor( ELEMENT, NAME, COMPONENT, OPTIONS ) {
    ...
    var
        ...
        P = PickerInstance.prototype = {
                ...
                if ( dontGiveFocus !== false ) {
                    ...
                    $document.on( 'click.' + STATE.id + ' focusin.' + STATE.id, function( event ) {
                        ...
                        // Check if there is a key movement or â€œenterâ€ keypress on the element.
                            ...
                            // On â€œenterâ€, if the highlighted item isn't disabled, set the value and close.
            ...
            set: function( thing, value, options ) {
                ...
                // When the method isn't muted, trigger queued â€œsetâ€ events and pass the `thingObject`.
    ...
    function focusToOpen( event ) {
        ...
        // If it's a focus event, add the â€œfocusedâ€ class to the root.
        if ( event.type == 'focus' ) {
...
function DatePicker( picker, settings ) {
    ...
    // If there's no value, default to highlighting â€œtodayâ€.
    else {
        calendar.
            set( 'select', null ).
...
DatePicker.prototype.disabled = function( dateToVerify ) {
    ...
    var
        ...
        isDisabledMatch = calendar.item.disable.filter( function( dateToDisable ) {
            ...
            // If it's an object, match a date within the â€œfromâ€ and â€œtoâ€ range.
...
DatePicker.prototype.isDateExact = function( one, two ) {
    ...
    // When we're working with date representations, compare the â€œpickâ€ value.
    if (
    ...
    // When we're working with range objects, compare the â€œfromâ€ and â€œtoâ€.
...
DatePicker.prototype.nodes = function( isOpen ) {
    ...
    // * For Firefox forms to submit, make sure to set the buttons' `type` attributes as â€œbuttonâ€.
    _.node(
        'div',
...
TimePicker.prototype.create = function( type, value, options ) {
    ...
    // If it's an object, use the â€œpickâ€ value.
...
TimePicker.prototype.disabled = function( timeToVerify ) {
    ...
    var clock = this,
        ...
        isDisabledMatch = clock.item.disable.filter( function( timeToDisable ) {
            ...
            // If it's an object, match a time within the â€œfromâ€ and â€œtoâ€ range.
...
TimePicker.prototype.isTimeExact = function( one, two ) {
    ...
    // When we're working with time representations, compare the â€œpickâ€ value.
    if (
        ( _.isDate( one ) || $.isArray( one ) ) &&
        ( _.isDate( two ) || $.isArray( two ) )
    ) {
...
TimePicker.prototype.nodes = function( isOpen ) {
    ...
    return _.node(
        ...
        // * For Firefox forms to submit, make sure to set the button's `type` attribute as â€œbuttonâ€.
        _.node(
            'li',
            _.node(
                'button',
